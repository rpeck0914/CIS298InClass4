...
public class CrimeDbSchema  {
    ...
    // Inner class to represent information about the CrimeTable This is the only table that we will have, but if we had more we
    //could make another inner class to hold information for that table as well
